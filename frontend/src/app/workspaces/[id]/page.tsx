...
export default function WorkspaceDetailPage() {
  ...
  const saveSettings = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setDescription(updatedWorkspace.description ?? "");
  ...
  const deleteCurrentWorkspace = async () => {
    const confirmed = window.confirm(
      "Delete this workspace and its workspace-owned content? This cannot be undone."
    );
    ...
    try {
      ...
      if (localStorage.getItem("workspace_id") === workspaceId) {
      ...
      <MainLayout>
        <div className="mx-auto max-w-3xl">
          <button
            ...
            className="mb-5 inline-flex items-center gap-2 text-xs font-medium text-[var(--muted)] hover:text-[var(--foreground)]"
          >
              ...
              {settingsOpen && (
                <Card className="mt-6">
                  ...
                  <div className="mt-6 border-t border-[var(--border)] pt-5">
                    ...
                    <p className="mt-1 text-xs text-[var(--muted)]">
                      Delete the workspace and its workspace-owned
                      documents, folders and teams.
                    </p>
